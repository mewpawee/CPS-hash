<?php
    ...
    $query = "SELECT * FROM (SELECT * FROM `egg` ORDER BY `egg`.`id` DESC LIMIT 50) egg ORDER BY `egg`.`id`";
...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
      ...
      <a class="navbar-brand mr-1" href="#">Kinaree</a>
        ...
        <footer class="">
          <div class="container my-auto">
            <div class="copyright text-center my-auto">
              <span>Copyright © Kinaree 2018</span>
            </div>
          </div>
        </footer>
